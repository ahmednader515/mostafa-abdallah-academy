...
export function LanguageToggle() {
  ...
  return (
    <button
      ...
      className="flex h-9 min-w-9 items-center justify-center rounded-[var(--radius-btn)] border border-white/15 bg-white/5 px-2 text-xs font-semibold tracking-wide text-white transition hover:bg-white/10"
